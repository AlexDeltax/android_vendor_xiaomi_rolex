...
LOCAL_SRC_FILES_64 := proprietary/vendor/lib64/vendor.display.color@1.0.so
LOCAL_SRC_FILES_32 := proprietary/vendor/lib/vendor.display.color@1.0.so
LOCAL_MULTILIB := both
...
include $(CLEAR_VARS)
LOCAL_MODULE := ColorControl
LOCAL_MODULE_OWNER := savoca
LOCAL_SRC_FILES := proprietary/vendor/app/ColorControl/ColorControl.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
